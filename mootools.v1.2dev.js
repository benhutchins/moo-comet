...
var Events = new Class({
	...
	fireEvent: function(type, args, delay, $var){
		if (!this.$events || !this.$events[type]) return this;
		if ($defined($var)) this.$var = $var;
		this.$events[type].each(function(fn){
			if ($defined(this.$var))
				this.$var = fn.create({'bind': this, 'delay': delay, 'arguments': args})();
			else
				fn.create({'bind': this, 'delay': delay, 'arguments': args})();
		}, this);
		return $defined(this.$var) ? this.$var : this;
	},
